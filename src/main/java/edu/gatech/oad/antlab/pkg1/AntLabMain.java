 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Evan Mi");
		  toPrint += p1.toString("emi6");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Jared Duncan");
		  toPrint += p2.toString("jduncan45");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Isaac Weintraub");
		  toPrint += p3.toString("iweintraub3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Manley Roberts");
                  toPrint += p4.toString("mroberts86");
